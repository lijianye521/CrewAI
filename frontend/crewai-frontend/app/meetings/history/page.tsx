    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6">
      <div className="max-w-7xl mx-auto">
          ...
          <Row gutter={16} className="mb-6">
            <Col span={6}>
              <Card className="bg-slate-700 border-slate-600 text-center">
                <Statistic
                  title={<span className="text-slate-300">总会议数</span>}
            ...
            <Col span={6}>
              <Card className="bg-slate-700 border-slate-600 text-center">
                <Statistic
                  title={<span className="text-slate-300">总消息数</span>}
            ...
            <Col span={6}>
              <Card className="bg-slate-700 border-slate-600 text-center">
                <Statistic
                  title={<span className="text-slate-300">总时长</span>}
            ...
            <Col span={6}>
              <Card className="bg-slate-700 border-slate-600 text-center">
                <Statistic
                  title={<span className="text-slate-300">平均时长</span>}
        ...
        <Modal
          ...
          width={1000}
          className="meeting-replay-modal"
        >
          {selectedMeeting && (
            <div>
              {/* 回放控制 */}
      ...
      <style jsx global>{`
        ...
        .meeting-replay-modal .ant-modal-content {
          background-color: rgb(51 65 85) !important;
        }
        .meeting-replay-modal .ant-modal-header {
          background-color: rgb(51 65 85) !important;
          border-bottom-color: rgb(100 116 139) !important;
        }
        .meeting-replay-modal .ant-modal-title {
          color: white !important;
        }
      `}</style>
    </div>
